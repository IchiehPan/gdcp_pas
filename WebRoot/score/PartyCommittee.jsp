  ...
  <tr>
    <td height="25" align="center" valign="bottom" class="td06"><table width="98%" border="0" cellspacing="3" cellpadding="0">
      <tr>
        ...
        <td valign="bottom" class="title">所有党委可以进行的操作</td>
      </tr>
    </table></td>
  </tr>
</table>
...
<table width="95%" border="0" align="center" cellpadding="0" cellspacing="0" class="table01">
  <tr>
    <td class="td_page">
  		<font size="2">（注意：此暂时没有可以显示的内容）</font>
    	
    	<input type="button" value="导出《中层干部考核得分表》" onclick="gotoUrl('<%=request.getContextPath()%>/averageScore_outputMiddleScore.action')" style="float: right;"/> 
    </td>
  </tr>
</table>
<br>
