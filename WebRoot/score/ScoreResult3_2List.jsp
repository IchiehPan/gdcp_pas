  ...
  <tr>
    ...
    <table width="98%" border="0" cellspacing="3" cellpadding="0">
      <tr>
        ...
        <td valign="bottom" class="title">已填写的评分考核表_列表</td>
      </tr>
    </table>
    </td>
  </tr>
...
<c:forEach var="ScoreRuleVO" items="${requestScope.soreRVList}" >
  <tr> 
   <td class="td_02"><%=i%><%i++;%></td>
	...
	<td class="td_02" style="color: red;">已考核</td>
	<form name="formn" action="${pageContext.request.contextPath}/EvaluatedRule_getScoreResultAndSecondIndex.action?scoreRuleId=${ScoreRuleVO.scoreRuleId}" method="post">
