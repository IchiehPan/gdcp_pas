...
import com.gdcp.pas.score.bo.EvaluatedRuleBO;
...
public class EvaluatedRuleAction {
	private static Logger logger = Logger.getLogger(EvaluatedRuleAction.class);
	...
	public String getRuleList() {
		...
		EvaluatedRuleBO scoreRB = new EvaluatedRuleBO();
		try {
